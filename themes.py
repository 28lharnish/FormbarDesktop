...
class Themes:
    def __init__(self):
        ...
        self.lightpalette = QApplication.palette()
        self.lightpalette.setColor(self.lightpalette.ColorRole.Window, qRgb(110, 110, 110))
        self.lightpalette.setColor(self.lightpalette.ColorRole.WindowText, qRgb(255, 255, 255))
        self.lightpalette.setColor(self.lightpalette.ColorRole.Base, qRgb(150, 150, 150))
        self.lightpalette.setColor(self.lightpalette.ColorRole.AlternateBase, qRgb(120, 120, 120))
        self.lightpalette.setColor(self.lightpalette.ColorRole.Accent, qRgb(255, 0, 0))
        self.lightpalette.setColor(self.lightpalette.ColorRole.Text, qRgb(255, 255, 255))
        self.lightpalette.setColor(self.lightpalette.ColorRole.Button, qRgb(120, 120, 120))
        self.lightpalette.setColor(self.lightpalette.ColorRole.ButtonText, qRgb(255, 255, 255))
